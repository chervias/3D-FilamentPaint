...
class FilPop:
	def __init__(self,nside,Nfil,theta_LH_RMS,size_ratio,size_scale,slope,magfield,seed,fixed_distance=False):
		self.nside			= nside
		self.Nfil			= Nfil
	...
	def get_centers(self):
		...
		if self.fixed_distance:
			...
			radii_random	= (0.5*self.magfield.size)*(np.random.uniform(0.0,1.0,self.Nfil))**(1./3.)
